# DESIGN2 — Ground truth (§14), renumbered and re-verified

This file is `DESIGN.md` §14 rewritten so a human can read it: one numbered entry per
fact, grouped by subject, stripped of narrative. Every entry was re-verified against
this tree on **2026-08-19** where verification does not need a rig; SITL measurements
are kept as recorded (owner's call, 2026-08-19). Facts that were superseded or
disproved are removed — the last section lists what went and why.
