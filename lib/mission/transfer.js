  ...
  start() {
    return new Promise((resolve) => {
      ...
      const handler = (decoded) => {
        ...
        // #3). Every MISSION_* message carries target_system/compid as core
        // (non-extension) fields, so a v1 peer or a truncated decode reads 0
        // (unaddressed) here exactly as it does for COMMAND_ACK.
