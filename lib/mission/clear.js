 ...
 *
 * This one is destructive — the *node* gates it behind a confirmation (§9,
 * §6); the machine itself simply erases the plan of the requested type and
 * reports the vehicle's ack. A non-zero ack is a failure reported verbatim.
 */
