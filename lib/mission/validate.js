...
/**
 * `MAV_CMD_NAV_*` navigation commands occupy 16–95 in the dialect. Kept for
 * callers that want the nav-family test on its own; the mission validator no
 * longer gates on it (see {@link validateMissionItems}).
 *
 * @param {number} cmd
 * @returns {boolean}
 */
