 ...
 * Fan-out maps a peer's declared autopilot to a firmware label. The reverse
 * direction had one caller — the Connection's vehicle snapshot, read only by
 * the removed profile-mismatch check — and went with it.
 */
