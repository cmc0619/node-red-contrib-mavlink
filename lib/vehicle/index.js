 ...
 * snapshot. There is no "custom path" mode — once XML is in the library it is a
 * pulldown entry.
 */
 ...
 * catalog. Custom XML reaches a profile by being downloaded into that catalog,
 * so there is no separate path mode to resolve.
 *
