 ...
 *
 * The registry is in-memory and per process. Each behavior owns one shared
 * instance (`locks` in lib/mission, `streamLocks` in lib/move); tests
 * construct their own isolated {@link LockRegistry} so they never contend
 * with each other.
 */
