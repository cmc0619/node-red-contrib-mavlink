...
/**
 * Keep PARAM_VALUE's nonfinite float values through JSON and file nodes.
 * JSON.stringify turns them into null, which would become zero on a later
 * numeric PARAM_SET coercion.
 *
 * @param {*} value
 * @returns {*}
 */
