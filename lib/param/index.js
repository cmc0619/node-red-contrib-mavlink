...
function numericEqual(a, b) {
  ...
  // A REAL32 param crosses the wire as a float32, so the echo comes back
  // quantized: setting 47.9 echoes 47.900001525878906, further from the
  // request than the absolute 1e-6 tolerance allows. Equality after float32
  // quantization means the vehicle stored exactly what we asked for.
