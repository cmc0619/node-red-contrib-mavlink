  ...
  switch (completionKey) {
    ...
    case COMPLETION.LAND: {
      ...
      if (altM <= LAND_ALT_THRESHOLD_M) {
        ...
        // threshold. An armed vehicle is not landed whatever its altitude
        // reads — the same gate the no-position fallback above already
        // applies. Unknown armed state (no HEARTBEAT decoded yet) does not
        // block, so the pre-existing altitude verdict is unchanged there.
