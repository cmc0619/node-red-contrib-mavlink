 ...
 * (§9 "one implementation per concept"), which stamps the record's `node`.
 *
 * Fields default: resultCode=null, resultParam2=null, target=null, elapsed=0, retries=0, command=null, commandId=null, detail=null.
 *
 ...
 *   extension decodes as 0, §14); null when no *terminal* ack settled the
 *   run, IN_PROGRESS-then-timeout included
 * @param {'ack'|'state'}  [fields.confirmedBy]  absent when nothing confirmed
