 ...
 * parses that string once at construction; this merge copies it per input
 * so payload overrides never leak into the next message. Payload properties
 * override configured properties before the command's 1–7 slots are read by
 * `buildParamArray`.
 *
