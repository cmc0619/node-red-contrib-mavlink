...
const PRESETS = [
  ...
  // heading control is the setpoint yaw field, which Move steer speaks.)
  {
    ...
    //
    // The carrier split is already ruled and enforced in carrier.js (§9): NaN
    // has no INT encoding, so an orbit that means "here" must ride
    // COMMAND_LONG, and buildCommandInt says so by name.
