 ...
 *
 *   - {@link makeStatusRecord} / {@link isStatusRecord} — output-1 record
 *     construction and miswire guard
...
const { AckWaiter, DEFAULT_TIMEOUT_MS, DEFAULT_MAX_RETRIES, DEFAULT_RETRY_INTERVAL_MS } =
  require('./ack');
