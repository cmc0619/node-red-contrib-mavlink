 ...
 *     (peer-table check → unconfirmed). A vehicle that has answered at all,
 *     IN_PROGRESS included, is never re-commanded: the command arrived, and
 *     silence after that is the vehicle's, not the link's.
 *
...
class AckWaiter {
  ...
  _onAck(decoded) {
    ...
    // Any answer at all proves the command arrived: from here silence is the
   ...
   * the TEMPORARILY_REJECTED back-off and the silence path.
   *
