...
function ackAddressedTo(fields, sourceIds) {
  if (fields.target_system !== 0 && fields.target_system !== sourceIds.sysid) return false;
  if (fields.target_component !== 0 && fields.target_component !== sourceIds.compid) return false;
  return true;
}
