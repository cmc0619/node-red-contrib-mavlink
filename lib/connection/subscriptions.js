...
class SubscriptionRegistry {
   ...
   *   as the rest of lib/connection (heartbeat.js, runtime.js); a throwing
   *   subscriber is logged here rather than crashing dispatch.
   */
  constructor(options) {
...
function matches(filter, decoded) {
  ...
  // that carries no such field is not addressed to this id and does not
  // (undefined never equals an id, so no special case is needed).
