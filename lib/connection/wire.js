 ...
 *
 * Absent keys leave the class default (0 for ints). Blank/non-finite ints are
 * not refused here — Buffer.write*Int* writes them as 0 (measured, §14); that
 * silence is not a library refusal, so the driver does not invent one (§0).
 *
