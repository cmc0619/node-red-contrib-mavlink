  ...
  _pump() {
    ...
    if (isBroadcast || isSystemBroadcast) {
      ...
      const learned = configured
        ? []
        : this.peerTable.endpointsForBroadcast(isBroadcast ? target.compid : 0, isBroadcast ? undefined : target.sysid);
