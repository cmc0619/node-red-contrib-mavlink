...
class Connection extends EventEmitter {
  ...
  _pump() {
    ...
    // target until an endpoint appears, then re-arm (issue #91). Broadcast
    // (sysid 0) is exempt — no endpoint is the definition of correct there.
    if (target && target.sysid !== 0) {
