...
class Connection extends EventEmitter {
  ...
  constructor(config, deps = {}) {
    ...
    this._disabled = Boolean(config.disabled);
   ...
   *
   * @returns {Promise<void>} resolves once listening, reconnecting, or
   *   immediately when disabled; rejects on a terminal startup failure
   */
  async start() {
  ...
  async _attemptReconnect() {
    ...
    // (DEFAULT_TIMEOUT_MS, lib/command/ack.js) — reconnect usually beats that
