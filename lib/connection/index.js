 ...
 *   - {@link SigningState} / {@link timestampFromMs}  — link id, sequence,
 *     replay, timestamp policy (§7)
 *   - {@link BAND}  — outbound queue band constants (§7)
 */

const { Connection, STATE } = require('./runtime');
const { PeerTable } = require('./peer-table');
const { SigningState, timestampFromMs } = require('./signing');
