...
class OutboundQueue {
   ...
   * @returns {QueueItem|undefined} the accepted item; a band no case answers
   *   to selects no behavior and enqueues nothing (§5)
  ...
  /**
   * Find the item that currently wins priority and age ordering.
   *
   * @param {number} now
   * @returns {QueueItem|null}
   */
