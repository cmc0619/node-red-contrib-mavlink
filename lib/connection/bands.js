...
/**
 * Resolve the queue band for one send (an agent's extension of the
 * no-defaults ruling to this site, not itself a recorded ruling). `msg.band` absent is a presence
