 ...
 * cluster). Distinct from `selection.mode` below (#231, declined): that one
 * *filters* the peer table and any unrecognised token behaves as 'all' by
 * design. This one picks which wire machine runs — `executeSequential` or
