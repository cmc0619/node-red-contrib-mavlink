...
/**
 * Convert a JS degrees value to a degE7 integer. Accepts an already-scaled
 * integer (pass-through) or a finite degree `Number`/`string` (× 10⁷, rounded).
 *
...
function degreesToDegE7(fieldName, value) {
  if (typeof value === 'number') {
    ...
    if (Number.isInteger(value)) return value; // already wire-scaled
