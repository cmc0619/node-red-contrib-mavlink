 ...
 * pointed with (§9 roster). It is *not* how a Blimp moves (§14, source-read):
 * Blimp never
 ...
 * @param {*} input.buttons    button bitmask, 0..65535; 0 is no button pressed
