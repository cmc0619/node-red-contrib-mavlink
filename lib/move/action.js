 ...
 *   IS the mode.
 *
 * A saved config without `action` matches no dispatch case and craters: the
 * editor always saves an explicit action, so a blank one is a hand-edited or
 * half-built config, not a choice.
 */
