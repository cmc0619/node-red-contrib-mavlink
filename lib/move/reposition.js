...
const { buildCommandInt } = require('../command/carrier');
const { isBlank } = require('../addressing/resolve');
const { degreesToRadians } = require('./frames');

/**
 * Move's reposition carrier: the guided goto every reference
 ...
 * blank speed → −1 (vehicle default), blank radius → 0 (ignored),
