...
class FtpMachine {
  ...
  _readAck(response) {
    ...
    // OpenFileRO already advertised the length. Stop when that many bytes are
    // in hand instead of probing past EOF — ArduPilot answers that probe with
    // a NAK whose offset is zero, and a zero-offset match is not required once
