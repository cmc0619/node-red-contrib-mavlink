...
const NAK_ERROR_NAME = Object.freeze({
  ...
  [NAK_ERROR.FAILERRNO]: 'errno failure',
  [NAK_ERROR.INVALIDDATASIZE]: 'invalid data size',
  [NAK_ERROR.INVALIDSESSION]: 'invalid session',
  [NAK_ERROR.NOSESSIONSAVAILABLE]: 'no sessions available',
  [NAK_ERROR.EOF]: 'end of file',
  [NAK_ERROR.UNKNOWNCOMMAND]: 'unknown command',
  [NAK_ERROR.FILEEXISTS]: 'file exists',
  [NAK_ERROR.FILEPROTECTED]: 'file protected',
  [NAK_ERROR.FILENOTFOUND]: 'file not found',
});
