...
const COMMAND_PARAM_ENUMS = {
  ...
  MAV_CMD_PREFLIGHT_REBOOT_SHUTDOWN: {
    1: 'REBOOT_SHUTDOWN_ACTION',
    2: 'REBOOT_SHUTDOWN_ACTION',
    3: 'REBOOT_SHUTDOWN_ACTION',
    6: 'REBOOT_SHUTDOWN_CONDITIONS',
  },
  // param 2 is MAV_DO_REPOSITION_FLAGS (bitmask); params 5–7 are lat/lon/alt.
