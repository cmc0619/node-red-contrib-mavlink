 ...
 * @property {string|null} description
 * @property {string|null} units
 * @property {string|null} enum  from compiled XML (`<param enum=`>)
 * @property {number|null} minValue
 * @property {number|null} maxValue
 * @property {number|null} increment
...
const { knownDialects, loadBundled, seedRoot, readManifest, seedStamp } = require('./bundled');
...
const { isFalseTrueEnum } = require('./naming');
