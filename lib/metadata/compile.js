...
function parseFile(fileName, xml) {
  ...
  const out = { includes: [], enums: [], messages: [] };
...
function compileXml(files, entryFileName) {
  ...
  for (const fileName of order) {
    ...
    mergeMessages(messages, idToName, parsed.messages, fileName);
  }
 ...
 * @returns {void}
 */
function mergeMessages(messages, idToName, fileMessages, fileName) {
